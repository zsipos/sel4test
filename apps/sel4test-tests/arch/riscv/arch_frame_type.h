...
#if __riscv_xlen == 64 && !defined(CONFIG_BUILD_ROCKET_CHIP_ZEDBOARD) && !defined(CONFIG_PLAT_ARIANE) &&!defined(CONFIG_PLAT_POLARFIRE)&& !defined(CONFIG_PLAT_QEMU_ZSIPOS) && !defined(CONFIG_PLAT_HW_ZSIPOS)
